    ...
    <div className="flex h-screen bg-[#EEF0F1]">
      ...
      >
        ...
        <div className="bg-white p-[15px] rounded-md shadow-sm mb-[10px] flex items-center space-x-4">
          ...
          <h2 className="text-[15px] font-[500] text-[#1E1E1E]">Edit Product</h2>
        </div>
        ...
        <div className="bg-white rounded-md shadow-md p-[16px]">
          <form>
            ...
            <div className="flex justify-end space-x-4">
              <button
                type="button"
                className="bg-[#FF0000] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
              >
                Delete
              </button>
              <button
