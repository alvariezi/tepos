...
<section className="bg-white py-12">
  ...
  <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center">
    <img
      src="/help.png"
      alt="Help"
      className="w-full lg:w-[45%] md:w-[42%] mt-[24px] mb-[30px] md:mb-0 md:mt-0"
    />
    <div className="text-left lg:ml-[70px] md:ml-[24px]">
      ...
      <p className="text-[15px] w-full lg:w-[400px] lg:text-[18px] md:text-[14px] md:w-[350px] text-[#1E1E1E] font-[400]">
